...
public val IconPack.Homeunselected: ImageVector
    get() {
        if (_homeunselected != null) {
            return _homeunselected!!
        }
        _homeunselected = Builder(name = "Homeunselected", defaultWidth = 24.0.dp, defaultHeight =
...
private var _homeunselected: ImageVector? = null
